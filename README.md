...
This is a digit recognizer i programmed for the famous Mnist Digit dataset using Numpy for training and PySide6 for the interface

Prerequisites:
- Must have Python installed (I have used Python 3.13.5)
- Must have Numpy installed
- Must have Pyside6 installed
